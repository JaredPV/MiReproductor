...
public class MainActivity extends AppCompatActivity implements VideoRVAdapter.VideoClickInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoRV = findViewById(R.id.rv_videos);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem menuI = menu.findItem(R.id.action_search);
        SearchView searchView = (SearchView) menuI.getActionView();
        searchView.setQueryHint("Buscar video");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode==STORAGE_PERMISSION){
            if(grantResults.length>0 && grantResults[0]==PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(this, "La aplicacion no funcionara sin el acceso", Toast.LENGTH_SHORT).show();
                finish();
            }
        }
    }
